...

{
  ...
  class ComponentDescription extends Description {
    ...
    constructor(component, type) {
      ...
      this.component = opr.Toolkit.resolveComponentClass(component, type);
      ...
      if (Array.isArray(template) && template.length) {
        ...
        for (const [item, type, index] of template.map(
          ...
          if (index === 0) {
            ...
            case 'function':
            case 'symbol':
              description = {component: opr.Toolkit.resolveComponentClass(item, type)};
              break;
            default:
          ...
          if (index === 1 && type === 'props') {
            const props = description.type === 'component'
                              ? this.getComponentProps(item, description.component)
