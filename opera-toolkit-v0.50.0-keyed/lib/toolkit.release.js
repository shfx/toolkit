...

{
  class Diff {
    ...
    componentPatches(component, description) {
      ...
      // TODO: add support for direct references to component classes and renderer
  ...
  class Template {
    ...
    static describe(template) {
      ...
      if (Array.isArray(template) && template.length > 0) {
        ...
        const [type, name, value] = getTypeAndName(template[0]);
